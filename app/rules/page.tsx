...
export default function RulesPage() {
  return (
    <LegalPageLayout
      icon={ShieldAlert}
      badge="قوانین امنیت و استفاده"
      title="قوانین الزام‌آور حفاظت از داده‌ها"
      description="این قوانین برای کاهش ریسک امنیتی، جلوگیری از افشای اطلاعات و تعریف مسئولیت مشترک بین وزیر و کاربر تدوین شده‌اند. استفاده از سرویس به معنای پذیرش کامل این قواعد است."
    >
      <section>
