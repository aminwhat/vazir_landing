      ...
      <section className="relative overflow-hidden px-4 pb-20 pt-20 md:pt-24">
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="mb-10 text-base leading-8 text-neutral-400 md:text-lg">
            استفاده از خدمات وزیر به معنای پذیرش شرایط این صفحه است. لطفا پیش از
            استفاده از سرویس، مفاد زیر را با دقت مطالعه کنید.
          </p>
          ...
          <article className="space-y-8 rounded-2xl border border-white/10 bg-neutral-900/60 p-6 md:p-8">
            ...
            <section>
              <h2 className="mb-3 text-2xl font-semibold text-white">۲. حساب کاربری و مسئولیت دسترسی</h2>
              <p className="leading-8 text-neutral-300">
                مسئولیت حفظ محرمانگی اطلاعات ورود (نام کاربری و رمز عبور) بر عهده
                کاربر است. تمامی فعالیت‌هایی که از طریق حساب کاربری انجام شود به
                نام کاربر ثبت خواهد شد.
              </p>
            </section>
            ...
            <section>
              <h2 className="mb-3 text-2xl font-semibold text-white">۴. مالکیت فکری</h2>
              <p className="leading-8 text-neutral-300">
            ...
            <section>
              <h2 className="mb-3 text-2xl font-semibold text-white">۵. پرداخت و اشتراک</h2>
              <p className="leading-8 text-neutral-300">
            ...
            <section>
              <h2 className="mb-3 text-2xl font-semibold text-white">۶. محدودیت مسئولیت</h2>
              <p className="leading-8 text-neutral-300">
                ...
                یا زیان‌های ناشی از عوامل خارج از کنترل سرویس را نمی‌پذیرد.
              </p>
            </section>

            <section>
              <h2 className="mb-3 text-2xl font-semibold text-white">۷. تعلیق یا خاتمه دسترسی</h2>
              <p className="leading-8 text-neutral-300">
            ...
            <section>
              <h2 className="mb-3 text-2xl font-semibold text-white">۸. تغییرات شرایط</h2>
              <p className="leading-8 text-neutral-300">
            ...
            <section>
              <h2 className="mb-3 text-2xl font-semibold text-white">۹. تماس با ما</h2>
              <p className="leading-8 text-neutral-300">
