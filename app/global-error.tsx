...
export default function GlobalError({
  ...
  return (
    <html lang="fa" dir="rtl">
      <body
        className={`${vazir.className} min-h-screen overflow-x-hidden bg-black text-white antialiased`}
      >
        <main className="min-h-screen bg-neutral-950 text-neutral-100 selection:bg-blue-500/30">
          <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-4 text-center">
            ...
            <div className="absolute right-0 top-40 -z-10 h-[280px] w-[560px] rounded-full bg-red-600/10 blur-[100px]" />
            ...
            >
              مشکلی غیرمنتظره در برنامه رخ داد
            </motion.h1>
            ...
            >
              لطفا یک بار دیگر تلاش کنید. اگر خطا پابرجا بود، از صفحه اصلی ادامه
              دهید.
            </motion.p>
